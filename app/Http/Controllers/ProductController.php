...
class ProductController extends Controller
{
    public function __construct()
    {
        ...
        // $this->data['Warna'] = AttributeOption::whereHas(
        //     'attribute',
        //     function ($query) {
    ...
    public function show($slug)
    {
        ...
        if ($product->type == 'configurable') {
            $this->data['color'] = ProductAttributeValue::getAttributeOptions($product, 'color')->pluck('text_value', 'text_value');
            $this->data['size'] = ProductAttributeValue::getAttributeOptions($product, 'size')->pluck('text_value', 'text_value');
            $this->data['lain'] = ProductAttributeValue::getAttributeOptions($product, 'lain')->pluck('text_value', 'text_value');
        }
